...
def send_registry_email(mail_to: str, password: str):
    """
    Отправка временного пароля для входа в ЛК на email.
    """

    context = {"password": password}
    html_template = "email/user_registry.html"
    text_template = "email/user_registry.txt"
...
def send_password_reset_token(reset_password_token):
    ...
    subject = "Сброс пароля на сервисе Желтый Грейдер"
